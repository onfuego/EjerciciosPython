...
while opcion < 6:
    ...
    opcion  = int(input("Favor ingrese una opcion: "))

    if opcion == 1:
        print("Los ingredientes seleccionados son: ", ingredientes)
        print()

    if opcion ==2:
    #1. Consultar si entre los ingredientes esta la masa tradicional
        if "masa tradicional" in ingredientes:
    #1.1 Si esta, consultar si la desea cambiar por masa delgada
            print("Cambiar masa tradicional por masa delgada?")
            print("Escriba 'S' para cambiar, o 'N' para conservar masa tradicional")
            print()
            cambiar = input().upper()
    #1.1.1 Si la quiere cambiar, eliminar de la lista masa tradicional y agregar la masa delgada
            if cambiar == "S":
    ...
    #1.2.1 Si esta, consultar si la desea cambiar por masa tradicional
            print("Cambiar masa delgada por masa tradicional?")
            print("Escriba 'S' para cambiar o 'N' para conservar masa delgada")
            cambiar == input().upper()
    #1.2.1.1 Si dice que si, eliminar de la lista la masa delgada y agregar la tradicional
            if cambiar == "S":
    ...
    #1.3.1 Consultar con un nuevo submenu que masa desea: 1 Tradicional 2. Delgada
    ...
    if opcion == 4:
        print("Que ingrediente desea agregar? (Escriba una de las siguientes opciones)")
        print("Tomate")
        print("Aceitunas")
        print("Queso")
        print("Peperoni")
        ...
        while nuevo !="tomate" and nuevo !="aceitunas" and nuevo !="queso" and nuevo !="peperoni" and nuevo !="pollo":
    ...
    if opcion == 5:
        ...
        print("Escriba el que se desea eliminar")
